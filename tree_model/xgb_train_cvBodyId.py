...
def build_data():
    ...
    body = pd.read_csv("/content/fnc-1/tree_model/train_bodies_processed.csv")
    stances = pd.read_csv("/content/fnc-1/tree_model/train_stances_processed.csv")
...
def build_test_data():
    ...
    body = pd.read_csv("/content/fnc-1/tree_model/test_bodies_processed.csv")
    stances = pd.read_csv("/content/fnc-1/tree_model/test_stances_unlabeled.csv") # needs to contain pair id
    data = pd.merge(stances, body, how='left', on='Body ID')
