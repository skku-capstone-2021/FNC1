...
def process():
    ...
    if not read:
        ...
        body_train = pd.read_csv("/content/fnc-1/tree_model/train_bodies_processed.csv", encoding='utf-8')
        stances_train = pd.read_csv("/content/fnc-1/tree_model/train_stances_processed.csv", encoding='utf-8')
        # training set
        ...
        test_flag = True
        if test_flag:
            body_test = pd.read_csv("/content/fnc-1/tree_model/test_bodies_processed.csv", encoding='utf-8')
            headline_test = pd.read_csv("/content/fnc-1/tree_model/test_stances_unlabeled.csv", encoding='utf-8')
